...
import { ExpressionWithTypeArgumentsReflection } from '../../doc/ast/type/expression'
...
export default class TypeExpression extends React.Component<
	TypeExpressionProps,
	TypeExpressionState
> {
	...
	render() {
		...
		return (
			<Paper className={this.getClassName()}>
				{this.renderType()}
				{expr.typeArguments && <TypeArguments typeArguments={expr.typeArguments} />}
			</Paper>
		)
	}
