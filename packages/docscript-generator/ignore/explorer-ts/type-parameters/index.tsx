...
export default class TypeParameters extends React.Component<
	TypeParametersProps,
	TypeParametersState
> {
		...
		if (this.props.asConstraint) {
			return (
				<div className={this.getClassName()}>
					<span>where </span>
					<div className={block('constraints')}>{this.renderContraints()}</div>
				</div>
			)
		} else {
			return <Brackets className={this.getClassName()}>{this.renderContraints()}</Brackets>
		}
	}
