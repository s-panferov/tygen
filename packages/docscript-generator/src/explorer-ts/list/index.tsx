...
export default class List extends React.Component<ListProps, ListState> {
	...
	renderItems() {
		...
		let view =
			this.props.view === ListView.Reference ? ListSectionView.Row : ListSectionView.Column

		let sections = Object.keys(groups).map(itemType => {
			let items = groups[itemType]
			return <ListSection key={itemType} view={view} itemType={itemType} items={items} />
		})
