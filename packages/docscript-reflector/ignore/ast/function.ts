import { FunctionDeclaration, Declaration, MethodSignature, SyntaxKind } from 'typescript'
...
import { TypeMemberReflection, visitInherenceInfo } from './type'
...
export function isFunctionDeclaration(statement: Declaration): statement is FunctionDeclaration {
	return statement.kind === SyntaxKind.FunctionDeclaration
}

export function isMethodDeclaration(statement: Declaration): statement is FunctionDeclaration {
	return statement.kind === SyntaxKind.MethodDeclaration
}

export function isMethodSignature(statement: Declaration): statement is FunctionDeclaration {
