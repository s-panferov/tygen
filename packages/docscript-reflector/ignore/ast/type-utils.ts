...
import { TypeReflection, CoreTypeReferenceReflection } from './type'

import { TypeReferenceReflection } from './type/type-reference'

import { visitTypeLiteral } from './type/type-literal'

import { isTypeLiteral, isObjectLiteralExpression } from './node-is'

import { StringLiteralTypeReflection } from './type/string-literal'
...
export function extractStringLiteralType(
