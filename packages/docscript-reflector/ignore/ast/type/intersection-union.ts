import { IntersectionTypeNode, IntersectionType, UnionTypeNode, Type } from 'typescript'
...
export function visitUnionType(node: UnionTypeNode, type: Type, ctx: Context): UnionTypeReflection {
	// TODO regiser inline types globally?
