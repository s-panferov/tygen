import { TypeReferenceNode, TypeReference, SyntaxKind, SymbolFlags, Node } from 'typescript'
...
export function visitTypeReference(
	...
	return {
		...
		typeArguments: node.typeArguments && node.typeArguments.map(ta => visitTypeNode(ta, ctx))
	}
}
