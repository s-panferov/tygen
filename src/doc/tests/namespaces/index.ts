...
describe('definitions', () => {
    ...
    it('___React', () => {
        let module = findModule('docscript:///src/doc/tests/namespaces/typings/react.d.ts/___React', ctx);
        expect(module).ok;
        expect(module.internal).true;
    ...
    it('test/item/deep', () => {
        let module = findModule('docscript:///src/doc/tests/namespaces/_module.ts/test/item/deep', ctx);
        expect(module).ok;
        expect(module.internal).true;
