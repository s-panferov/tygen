...
} from '../../doc/ast/type/type-literal'
...
export default class TypeLiteral<P extends TypeLiteralProps> extends React.Component<P, TypeLiteralState> {
	...
	render() {
		...
		let indexSignatures: IndexSignatureReflection[] = type.members.filter(sig => isIndexSignatureReflection(sig)) as any
		let callSignatures: CallSignatureReflection[] = type.members.filter(sig => isCallSignatureReflection(sig)) as any
