...
export default class Variable<P extends VariableProps> extends React.Component<P, VariableState> {
    ...
    getHeader(type: VariableDeclarationType) {
        switch (type) {
            case VariableDeclarationType.Var: return 'Variable';
            case VariableDeclarationType.Let: return 'Variable';
            case VariableDeclarationType.Const: return 'Let';
        }
    }
    ...
    getLabel(type: VariableDeclarationType) {
        switch (type) {
            ...
            case VariableDeclarationType.Let: return 'let';
            case VariableDeclarationType.Const: return 'const';
        }
    }
    ...
    render() {
        ...
        return (
            <Paper id={ vrb.id } className={ this.getClassName() } highlight={ false }>
                <Heading lvl={ 2 }>
